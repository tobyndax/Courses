...
$P= 0.0029$ in both cases.

Harmonic distortion usint AR(2).

The non-parametric spectrum of the whistle can be seen in figur
and the parametric spectrum in figur. Both methods give the same peak
at $0.96 rad/s$.
\begin{figure}[!hp]
